        ...
        <header>            
                ...
                <div class="div-trazilica">                    
                    <form action="action/page">
                      <input type="text" name="search" placeholder="Pretraži Booki webshop" id="input-header-pretrazi" />                                       
                    </form>
                     <div id="div-ikonica-search">                    
                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="darkgreen" class="bi bi-search" id="search" viewBox="0 0 16 16">
                ...
                <div>
                        ...
                        <Link to="/cart">
                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="darkgreen" class="bi bi-basket" id="Kosara" viewBox="0 0 16 16">
                ...
                <div>                                       
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="darkgreen" class="bi bi-facebook" id="Face" viewBox="0 0 16 16">
                        <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951"/>
                        </svg>                        
                        </a>
                    <a href="https://www.instagram.com/" target="_blank">
                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="darkgreen" class="bi bi-instagram" id="Insta" viewBox="0 0 16 16">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="darkgreen" class="bi bi-twitter-x" id="Twitt" viewBox="0 0 16 16">
            ...
            <section class="head2">
                <Link to="/">
                    <div class="div-Logo">
                        <img src="./book_PNG51049.png" id="logo" alt="Logo Booki" title="Prodaja knjiga Booki" width="100px" height="100px" />
                        </div>
                </Link>                
