...
function Kontakt() {
    return (
        ...
        <div className="kontakt-wrapper">       
            ...
            <input type="text" id="ime" name="ime" placeholder="Upišite ime i prezime" className="ime-prezime" />
            <br />
      ...
      <small>Suglasan sam sa prikupljanjem osobnih podataka u svrhu kontakta
      (privolu je moguće opozvati u bilo kojem trenutku).</small>
      </p>
      <br />           
